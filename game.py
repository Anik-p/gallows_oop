...
class Game:
    """
    Класс, отвечающий за управлением игровым процессом
    Он отвечает за:
    1) Инициализацию игровой логики;
    2) Отвечает за валидацию водимой буквы в начале и перезапуске игры;
    ...
    def _instance_core(self, title: str):
        """Создает инициализатор игровой логики"""
        self._core = core.Core(title)

    def _instance_score(self, level):
        """Создает инициализатор подсчета очков"""
